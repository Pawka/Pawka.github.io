...
## Writing a game for ZX Spectrum
...
- Compile Scheme into WebAssembly.

## Advent of Code in 25 languages

Personal score: 3/5.

- Intro into AoC. Since it was a lightning talk so the half of time was spent on
  intro.
- Picked languages shuffled randomly.
...
## Why your PC has only 16 colors?
